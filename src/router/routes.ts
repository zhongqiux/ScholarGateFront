...
export const routes = [
    ...
    {path: '/explorePaper', name: '检索论文', title: 'explorePaper', component: () => import('@/pages/SearchDetail.vue')},
    {path: '/exploreAuthor', name: '检索作者', title: 'exploreAuthor', component: () => import('@/pages/SearchAuthor.vue')},
    {path: '/exploreInstituition', name: '检索机构', title: 'exploreAuthor', component: () => import('@/pages/SearchInstituition.vue')},
    ...
    {path: '/identify', name: '', title: '认证', component: ()=>import('@/components/Claim/ClaimRequest.vue')},
